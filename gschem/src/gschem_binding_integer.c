 ...
 * Copyright (C) 2014-2020 gEDA Contributors (see ChangeLog for details)
 *
...
static gboolean
update_model (GschemBinding *parent);

static gboolean
update_widget (GschemBinding *parent);
...
update_model (GschemBinding *parent)
{
  GschemBindingInteger *binding = GSCHEM_BINDING_INTEGER (parent);
  int number;
