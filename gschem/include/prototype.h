...
void i_callback_view_menubar(gpointer data, guint callback_action, GtkWidget *widget);
void i_callback_view_toolbar(gpointer data, guint callback_action, GtkWidget *widget);
