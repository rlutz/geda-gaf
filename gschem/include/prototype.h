...
SCM g_keys_view_menubar(SCM rest);
SCM g_keys_view_toolbar(SCM rest);
...
void i_callback_edit_find_patch(gpointer data);
...
void i_callback_view_menubar(gpointer data);
void i_callback_view_toolbar(gpointer data);
...
void i_callback_add_path (gpointer data);
