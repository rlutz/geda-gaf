...
int main(void)
{
	...
	assert(rev2a != NULL);
	assert(xorn_delete_selected_objects(rev2a, sel) == 0);
	...
	assert(rev2b != NULL);
	assert(xorn_delete_selected_objects(rev2b, sel) == 0);
	...
	assert(rev2c != NULL);
	assert(xorn_delete_selected_objects(rev2c, sel) == 0);
	...
	assert(rev2d != NULL);
	assert(xorn_delete_selected_objects(rev2d, sel) == 0);
